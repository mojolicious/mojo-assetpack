...
$t->get_ok('/')->status_is(200)->element_exists(qq(img[src="/asset/99cc392264/photo-1429734160945-4f85244d6a5a.jpg"]));
$t->get_ok($t->tx->res->dom->at('img')->{src})->status_is(200)->header_is('Content-Type' => 'image/jpeg');
