...

{
  ...
  # inlined
  $t->get_ok('/inline')->status_is(200)->text_like('style', qr{background: \#a1a1a1;.*background: \#b1b1b1;}s);
...
{
  my $t = t::Helper->t({minify => 1});
  skip 'sass required', 4 unless $t->app->asset->preprocessors->can_process('scss');
  diag "sass minify=1";
