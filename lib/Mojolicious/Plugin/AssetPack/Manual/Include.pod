...
The description below use the example CSS asset below. The same rules apply to
...
This will result in a single html link tag in production mode, and a list of
link tags in development mode.
